  ...
  return (
    <section id="contact" className="w-[500px] mx-auto my-8 bg-white relative">
      ...
      <div className="sectionheader">
        <h1 className="bg-[#F2385A] font-oswald text-2xl py-3 px-4 text-white shadow-[0_0.06em_0_#424242] relative">
          CONTACT
        </h1>
      </div>
      ...
      <article className="p-4">
        <p className="mb-4">
          Yoda soon you will call me master Governor Tarkin. A new hope Boba Fett bantha forest
          moon. Tusken raider Master Yoda do or do not never tell me the odds.
        </p>

        {/* Toggle button for contact form */}
        <label
          htmlFor="checkcontact"
          className="contactbutton block w-full h-12 bg-[#F2385A] shadow-[1px_1px_0_0_#832032,2px_2px_0_0_#832032,3px_3px_0_0_#832032] text-center mt-5 mb-0.5 cursor-pointer hover:shadow-[1px_1px_0_0_#832032] hover:mt-6 hover:ml-0.5 hover:mb-0 transition-all duration-250"
        >
        ...
        <form
          action=""
          method="post"
          className="contactform overflow-hidden max-h-0 transition-all duration-300 ease-linear"
        >
          {/* Name field */}
          <p className="input_wrapper relative mt-4">
            ...
            <label
              htmlFor="contact_nom"
              className="absolute left-0 top-0 h-full bg-[#F2385A] text-white font-oswald w-[15%] text-center leading-[2.8em] transition-all duration-250 ease-in-out"
            >
              NAME
            </label>
          </p>
