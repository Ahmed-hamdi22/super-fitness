  ...
  return (
    <div className={`relative rounded-2xl overflow-hidden ${className}`} onClick={onClick}>
      ...
      <div className="absolute bottom-0 left-0 w-full backdrop-blur-3xl bg-light-silver-300/50 dark:bg-dark-gray-900/50 px-6 py-4">
        {/* Title */}
        <h3 className="text-lg font-bold font-baloo text-dark-gray-800  dark:text-light-silver-300 uppercase tracking-wide">
          {title}
        </h3>
        ...
        <div className="mt-2">
          ...
          {!isExplorer && isExpanded && description && (
            <p className="mt-2 text-sm text-light-silver-300 bg-black/60 p-2 rounded-md">
              {description}
            </p>
          )}
        </div>
